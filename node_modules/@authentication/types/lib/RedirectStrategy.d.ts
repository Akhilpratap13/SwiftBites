...
export default interface RedirectStrategy<State = Mixed, InitOptions = {}, CallbackOptions = {}> {
     ...
     * request.
     */
    redirectToProvider(req: Request, res: Response, next: NextFunction, options?: InitOptions & {
        state?: State;
    }): void;
    /**
